...
libsrtp, usrsctp, and plog sources; the binary identifies OpenSSL 3.6.0. The
...
| OpenSSL 3.6.0 | TLS and cryptography inside `datachannel.dll` | Apache 2.0 | [openssl/openssl](https://github.com/openssl/openssl/tree/openssl-3.6.0) |
