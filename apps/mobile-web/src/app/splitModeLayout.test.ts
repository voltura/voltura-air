...
import {
  getStableScreenOrientation,
  splitModeMinimumWidth,
  supportsSplitModeLayout,
} from "./splitModeLayout";
...
describe("supportsSplitModeLayout", () => {
  ...
  it.each([
    ...
    "handles stable orientation for a %s",
    (_label, width, height, orientation, touch, expected) => {
