...
interface SplitModeSettingsProps {
  settings: TrackpadSettings;
  updateSetting: <Key extends keyof TrackpadSettings>(
    key: Key,
    ...
    <>
      <div className="toggle-row">
        ...
        <input
          id={splitModeId}
          type="checkbox"
          checked={settings.enableSplitMode}
          onChange={(event) => {
            updateSetting("enableSplitMode", event.target.checked);
          }}
        />
      </div>
      ...
      <div className="setting-group">
        ...
        <div className="segmented-control" aria-label="Trackpad placement in split mode">
          <button
            type="button"
            className={settings.splitTrackpadPlacement === "left" ? "active" : ""}
            onClick={() => {
              updateSetting("splitTrackpadPlacement", "left");
            }}
          >
            Left
          </button>
          <button
            type="button"
            className={settings.splitTrackpadPlacement === "right" ? "active" : ""}
            onClick={() => {
              updateSetting("splitTrackpadPlacement", "right");
            }}
          >
            Right
          </button>
      ...
      <label className="toggle-row">
        ...
        <input
          type="checkbox"
          checked={settings.splitShowStatusRow}
          onChange={(event) => {
            updateSetting("splitShowStatusRow", event.target.checked);
          }}
        />
      </label>
    </>
