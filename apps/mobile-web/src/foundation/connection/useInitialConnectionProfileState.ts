...
import { hasPairingTokenParameter, parsePairingLink, parsePcUrl } from "../pairing/pairingLink";
import {
  createPcProfile,
...
export function useInitialConnectionProfileState() {
  ...
  return {
    ...
    initialPairing,
    screenshotMode,
    shouldActivateAddressPc: !addressHasInvalidPairing && initialPairing === null && (addressHasPcUrl || hasOnlyAddressIdentity),
    shouldStoreAddressPc: !addressHasInvalidPairing && (initialPairing !== null || addressHasPcUrl || hasOnlyAddressIdentity),
    storedPcProfiles
  };
}
