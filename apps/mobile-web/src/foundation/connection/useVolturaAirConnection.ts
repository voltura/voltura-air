...
export function useVolturaAirConnection() {
  ...
  const {
    audioState, awakeCapability, clipboardReadPermission, clearRuntimeState, customScreensCapability, hostStatus, powerCapabilities, presentationCapability, setAudioState,
