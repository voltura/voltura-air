    ...
    Func<bool> isLoading)
{
    public void AddTo(StackPanel parent)
    {
        ...
        var controls = new[]
        {
            ...
            (Control: visuals.CreateCheckBox("Allow paired devices to use their camera as the PC webcam", permissions.AllowPhoneWebcam), Key: "phone-webcam"),
    ...
    private void Save((SettingsCheckBox Control, string Key)[] controls)
    {
        ...
        AppPermissionSettings.Save(new HostPermissionSet(
            ...
            AllowDisplayControl: IsAllowed("display-control"),
            ...
            AllowPhoneWebcam: IsAllowed("phone-webcam"),
