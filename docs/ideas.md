...
| Phone microphone as a Windows input | Keep microphone work separate from the approved phone-webcam plan. A virtual microphone has different Windows driver, signing, echo, device-selection, privacy, and audio-latency boundaries and needs its own isolated feasibility decision. |
