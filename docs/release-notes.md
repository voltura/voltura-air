...
Maintain user-facing release notes newest first. Every `## v<version>` section
contains observable changes followed by the freeware and unsigned-release
notices. Remove the comment and add concise observable changes before releasing
v0.7.4.
