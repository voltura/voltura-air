    ...
    <main>
      ...
      <section id="features" class="feature-band" aria-label="Core features">
        ...
        <article>
          ...
          <p>Use media, YouTube, Kodi, fullscreen, browser, volume, navigation-ring, and mini-trackpad controls, pair securely on the local network, auto-refresh the installed web app, and recover visibly if input delivery stops being confirmed.</p>
        </article>
      </section>
      ...
      <section id="download" class="download-band">
        <div>
          ...
          <p>
            Download the latest <strong>VolturaAir-Setup-&lt;version&gt;-win-x64.exe</strong> from GitHub releases.
