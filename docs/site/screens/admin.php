...
$body = ($moderationError !== '' ? '<p class="catalog-moderation-error" role="alert">' . air_screen_h($moderationError) . '</p>' : '') . '<p class="catalog-lede">Review each screen and its author notes before making it public.</p><section class="catalog-moderation">';
