...
export const packageFilenames = new Map([
  ["official.vlc", "vlc.volturascreen"],
  ["official.spotify", "spotify.volturascreen"],
  ["official.browser", "web-browser.volturascreen"],
  ["official.netflix", "netflix.volturascreen"],
  ["official.primeVideo", "prime-video.volturascreen"],
  ["official.disneyPlus", "disney-plus.volturascreen"],
  ["official.twitch", "twitch.volturascreen"],
  ["official.plex", "plex.volturascreen"],
  ["official.zoom", "zoom.volturascreen"],
  ["official.windows", "windows.volturascreen"],
  ["official.power", "power.volturascreen"],
  ["official.displays", "displays.volturascreen"],
  ["official.windowsPhotos", "windows-photos.volturascreen"],
  ["official.blender", "blender.volturascreen"],
]);
