...
const components = [
  ...
  { name: "lucide-react", version: "1.31.0", license: "ISC and MIT", source: "https://github.com/lucide-icons/lucide" },
...
async function verifyMaintainedInventory() {
  ...
  for (const [name, version] of directHostPackages) {
    ...
    if (!new RegExp(`PackageReference Include="${escapedName}"`, "u").test(hostProject) ||
        !new RegExp(`PackageVersion Include="${escapedName}" Version="${escapedVersion}"`, "u").test(centralPackages)) {
