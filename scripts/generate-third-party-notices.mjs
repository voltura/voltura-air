...
const components = [
  { name: "@noble/curves", version: "2.2.0", license: "MIT", source: "https://github.com/paulmillr/noble-curves" },
  { name: "@noble/hashes", version: "2.2.0", license: "MIT", source: "https://github.com/paulmillr/noble-hashes" },
  { name: "jsqr", version: "1.4.0", license: "Apache-2.0", source: "https://github.com/cozmo/jsQR" },
  { name: "lucide-react", version: "1.27.0", license: "ISC and MIT", source: "https://github.com/lucide-icons/lucide" },
...
async function verifyMaintainedInventory() {
  ...
  const requiredInventoryText = [
    ...
    "OpenSSL 3.6.0",
    "Microsoft WebView2 SDK | 1.0.4078.44",
    "QRCoder | 1.8.0",
  ...
  if (installedWsPackage.version !== "8.21.1" || relayPackage.dependencies?.ws !== "^8.18.3") {
