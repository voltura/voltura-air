...
internal static class ProtocolFrameAssert
{
    private static readonly Dictionary<string, string[]> RequiredFields = new()
    {
        ...
        ["apps.list.result"] = ["operationId", "succeeded", "message", "windows"],
        ["apps.activate.result"] = ["operationId", "windowId", "succeeded", "message"],
        ["apps.close.result"] = ["operationId", "windowId", "succeeded", "message"],
        ["apps.preview.offer"] = ["operationId", "previewId", "offerSdp", "hostSignature"],
        ["apps.preview.answer.result"] = ["operationId", "succeeded", "message"],
        ["apps.preview.ended"] = ["previewId", "reason", "message"],
